...
ADD CONSTRAINT UNIQUEMAUV UNIQUE(MAUNGVIEN)    
...
-------thêm nhân viên thì thêm tài khoản
CREATE TRIGGER Trigger_THEMNV
ON NHANVIEN
FOR INSERT
AS
	BEGIN
		DECLARE @L NVARCHAR(10)
		SET @L=(SELECT inserted.MANV FROM inserted )
		INSERT INTO TAIKHOAN VALUES (@L,'abc','True')
	END
...
VALUES ('CTHD0001','HDLD0002','NV000001',2,'01/01/2019','01/02/2019','01/01/2020',12000000)
--,
...
INSERT INTO LOAIKHENTHUONG
VALUES 	('LKT00002',N'Khen thưởng tháng 13',1000000)
INSERT INTO LOAIKHENTHUONG
VALUES ('LKT00003',N'Khen thưởng chuyên cần',1000000)
...
SET DATEFORMAT DMY
INSERT INTO CHITIETKHENTHUONG
VALUES('CTKT0002','LKT00002','NV000001','30/12/2018')
SET DATEFORMAT DMY
INSERT INTO CHITIETKHENTHUONG
VALUES('CTKT0003','LKT00003','NV000001','30/08/2018')
		--,
...
VALUES ('CTDT0001','KDT01','NV000001','03/01/2019','03/01/2019')
SET DATEFORMAT DMY
INSERT INTO CHUONGTRINHDAOTAO
VALUES ('CTDT0002','KDT03','NV000001','03/01/2019','03/01/2019')
		--,
...
SET DATEFORMAT DMY
INSERT INTO BANGCHAMCONG
VALUES ('NV000001','02/01/2019','08:00am','17:00pm')
SET DATEFORMAT DMY
INSERT INTO BANGCHAMCONG
VALUES ('NV000001','03/01/2019','08:00am','17:00pm')
SET DATEFORMAT DMY
INSERT INTO BANGCHAMCONG
VALUES ('NV000001','04/01/2019','08:00am','17:00pm')
SET DATEFORMAT DMY
INSERT INTO BANGCHAMCONG
...
INSERT INTO DANHMUCTANGCA
VALUES('LC02',N'Tăng chủ nhật lễ',4,8)
INSERT INTO DANHMUCTANGCA
VALUES('LC03',N'Tăng chủ nhật',2,8)
INSERT INTO DANHMUCTANGCA
VALUES('LC04',N'Tăng tối',1,4)
...
INSERT INTO DS_KYLUAT
VALUES ('KL002',N'Trộm cắp',N'Đuổi việc','0')
INSERT INTO DS_KYLUAT
VALUES ('KL003',N'Tiết lộ bí mật kinh doanh',N'Đuổi việc','0')
